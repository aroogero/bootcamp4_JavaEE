...
public class HomePage_Sprint1Servlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request,
                         HttpServletResponse response) throws ServletException, IOException {
        ArrayList<ClientTask> tasks = DBManager_Sprint1.getAllTasks(); //чтобы вывести на homepage подтягиваем все объекты ArrayList-a
