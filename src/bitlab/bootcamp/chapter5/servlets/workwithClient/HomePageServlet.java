...
public class HomePageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        //JDBC вызываем метод который выедет нам список который находится в sql
        DBManager1_jdbc.getAllUsers();
        //меняем поставщика на sql
        ArrayList<ClientUser> users = DBManager1_jdbc.getAllUsers();


        //Чтобы вывести на главную страницу хоумпэйдж, нам нужно подтянуть эррейлист
        //Тут поставщик сам эррейлист  ArrayList<ClientUser> users = DBUtil.getUsers();
